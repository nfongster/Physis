...
class TestParticleSystem:
    ...
    def test_get_particles(self):
        ps = physis.ParticleSystem()
        ps.add(physis.KinematicParameters())
        pmap = ps.particles()
        assert pmap[0] != None
        assert len(pmap) == 1
    ...
    def test_update_particle(self):
        ...
        v = physis.Vec2(1, 1)
        a = physis.Vec2(-9, 0)
        ps.add(physis.KinematicParameters(r, v, a))
        ...
        v2 = physis.Vec2(-3, 4)
        a2 = physis.Vec2(0, 3)
        ps.update(0, physis.KinematicParameters(r2, v2, a2))
    ...
    def test_step_particle(self):
        ps = physis.ParticleSystem()
        v = physis.Vec2(1, 0)
        ps.add(physis.KinematicParameters(physis.Vec2(), v, physis.Vec2()))
        ps.step(1)
