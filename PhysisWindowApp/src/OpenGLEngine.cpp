...
{
    m_system_state->AddParticle(KinematicParameters(), 0.015);
}
...
void OpenGLEngine::AddParticle(const KinematicParameters& parameters, const float& radius)
{
    m_system_state->AddParticle(parameters, radius);
}
