...
TEST_CASE("Particle system can be iterated with multiple particles")
{
	...
	for (int i = 0; i < count; i++)
		ps.Add(KinematicParameters(), 0.0f);
...
TEST_CASE("Particle system can step 1 particle")
{
	...
	auto v0 = Vec2(1, 1);
	auto a0 = Vec2(-1, 1);
	ps.Add(KinematicParameters(r0, v0, a0), 0.0f);
...
TEST_CASE("Particle system can step multiple particles")
{
	...
	auto v01 = Vec2(1, 1);
	auto a01 = Vec2(-1, 1);
	ps.Add(KinematicParameters(r01, v01, a01), 0.0f);

	auto r02 = Vec2(2, -3);
	auto v02 = Vec2(9, 3);
	auto a02 = Vec2(-7, 16);
	ps.Add(KinematicParameters(r02, v02, a02), 0.0f);
